        ...
        <div className='flex-1 flex-col'>
          ...
          <div className='relative w-full h-[5px] bg-[#3a3a43] mt-2'>
            <div className='absolute h-full bg-[#4acd8d]' style={{
              width: `${calculateBarPercentage(state.
                target, state.amountCollected)}%`, maxWidth: '100%'
            }}>
            </div>

            <div className="p-3 text-[#dbb13d] text-xl bg-black">
              <button onClick={() => navigate('/update-project')}>Update Project</button>
            ...
            <div className='mt-[30px]'>
              ...
              <div className='my-[20px] p-4 bg-[#13131a] rounded-[10px]'>
                <h4 className=' font-epilogue font-semibold text-[14px]
                 leading-[22px] text-white'>Back it because you bealive in it.</h4>
                <p className='mt-[20px] font-epilogue font-normal 
                leading-[22px] text-[#808191]'>Support the project for no reward, just bacuse it speaks to you</p>
              </div>
              <div>
                <CustomButton
                  btnType="button"
